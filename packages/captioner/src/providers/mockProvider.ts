...
export async function generateMock(opts:{platform:Platform, brief:string, productTags:string[], location?:string, features?:string[], brandTone?:string[], seed?:number}):Promise<CaptionJSON>{
