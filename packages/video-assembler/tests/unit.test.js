...
describe('BrandKitLoader', () => {
    ...
    describe('findMatchingFont', () => {
        it('should find exact font match', () => {
            ...
            const result = BrandKitLoader.findMatchingFont('Arial', availableFonts);
        ...
        it('should return null for no match', () => {
            const availableFonts = ['Arial', 'Helvetica'];
            const result = BrandKitLoader.findMatchingFont('Comic Sans', availableFonts);
...
describe('Watermark', () => {
    describe('generateWatermarkFilter', () => {
        it('should generate basic watermark filter', () => {
            const filter = Watermark.generateWatermarkFilter('/path/to/watermark.png', 1920, 1080, { scale: 0.1, opacity: 0.8, position: 'bottom-right' });
        ...
        it('should handle different positions', () => {
            const filter = Watermark.generateWatermarkFilter('/path/to/watermark.png', 1920, 1080, { position: 'top-left' });
